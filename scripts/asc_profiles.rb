#!/usr/bin/env ruby
# Manage the App Store provisioning profiles used by the iOS release workflow.
#
...
# .github/workflows/build-ios.yml's ExportOptions — keep them in sync.
#
# The bundle ids and profile names are shared with the native iOS app repo
# (same team 8XG39X5CL8, same App IDs), so profiles created for either repo
# are reused by both.
